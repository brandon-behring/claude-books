...
- **Shaping I/O** — the prompting craft that shapes what goes in, and the levers that make machine-readable output reliable.
...
- **The map:** capability chapters (build-vs-buy, tool minimization, MCP, shaping I/O) → coordination chapters (sub-agents, multi-agent).
