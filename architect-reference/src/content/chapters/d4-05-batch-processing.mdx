...
- **Billing + beta** — billed only for `succeeded`; `errored`/`canceled`/`expired` are free; the `output-300k-2026-03-24` beta raises `max_tokens` to 300,000 on batch for Opus 4.7/4.6 and Sonnet 4.6.
