...
_The previous two chapters managed context *within* a session. This one persists it *across* sessions. It is the most openly unsolved topic in the Part — the practices here are current best-practice scaffolding around a contested design space, not settled science, and the chapter says so plainly._
