...
<WorkedExample id="d5-01-diagnose-the-mode" title="Diagnosing three long-session failures" expanded>
...
<Solution for="d5-01-pr-cumulative">
...
<Solution for="d5-01-pr-compaction-loss">
