...
Three independent evidence classes land on the same rule — keep the always-loaded file short and hand-curated: Anthropic's official "cut any line whose removal wouldn't cause a mistake,"<Citation src="anthropic-cc-best-practices" /> HumanLayer's practitioner "under sixty lines, don't auto-generate,"<Citation src="humanlayer-claudemd" /> and the ETH study's measured "describe only minimal requirements."<Citation src="eth-agentsmd-study" /> Official + practitioner + a controlled study agreeing is the strongest convergence in this book. <Tag kind="convergence" />
</Convergence>
