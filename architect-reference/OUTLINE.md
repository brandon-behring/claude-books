# Architect's Reference — Part: Environment & Context Engineering (outline v0)
...
- Markdown only — no build needed now; once chapters are authored, `npm -w architect-reference run validate && build` applies.
