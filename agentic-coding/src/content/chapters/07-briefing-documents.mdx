...
**Role 3: Vocabulary.** Precise terms that map to specific actions. "Validate" means `pytest tests/ && ruff check src/`. "Ship" means commit, push, open PR. This is the precision vocabulary from [Ch 3 Prompting](/03-prompting-as-specification/) made stable across sessions.
