...
Each layer has tool-specific instruments. For the Claude-Code ones — the commands that probe each layer, plus how to smoke-test and adversarially test a rule — see <BookLink book="handbook" to="chapters/ch14-antipatterns-recovery/#systematic-diagnosis-the-four-failure-layers">the Handbook's four-layer diagnosis</BookLink>.
