...
2. **Input validation** — preconditions at function entry. Fail fast with explicit errors (the fail-fast principle from [Ch 1](/agentic-coding/01-agent-mental-model/)).
