...
This book is built with `@brandon_m_behring/book-scaffold-astro` (tools profile, currently v3.5.0). It's the practitioner volume of the three-book series — the "how to *use* Claude effectively" angle.
